import type { DjikstraGraph } from "./types";

// Ported from here: https://github.com/justjavac/deno_dijkstra
...
export const dijkstra = {
  ...
  find_path: function (graph: DjikstraGraph, s: string, d: string): string[] {
